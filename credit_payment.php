...
<head>
    ...
    <link href="./css_files/credit_payment.css" rel="stylesheet">
</head>
<body>
    <div class="container">
        ...
        <div class="col-lg-9">
            ...
            <div class="accordion-item mb-3">
                ...
                <div class="accordion-body">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control" placeholder="Enter the name on card">
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="mb-3">
                    ...
                    <div class="col-lg-3">
                        ...
                        <input type="password" class="form-control" placeholder="Enter the CVV">
                        </div>
                    </div>
                    </div>
                </div>
            ...
            <div class="accordion-item mb-3 border">
                ...
                <div class="accordion-body">
                    ...
                    <input type="email" class="form-control" placeholder="Enter your PayPal email address">
                    </div>
                </div>
                </div>
            </div>
        ...
        <div class="col-lg-3">
            ...
            <div class="p-3 bg-light bg-opacity-10">
                ...
                <span>Subtotal</span> <span><?php echo"$subtotal EGP";?></span>
                </div>
                <div class="d-flex justify-content-between mb-1 small">
                <span>Shipping</span> <span>70 EGP</span>
                </div>
                <hr>
                <div class="d-flex justify-content-between mb-4 small">
                <span>TOTAL</span> <strong class="text-dark"><?php echo"$total EGP";?></strong>
                </div>
                ...
                <label class="form-check-label" for="subscribe">
                    Get emails about product updates and events. If you change your mind, you can unsubscribe at any time. <a href="#" class="link">Privacy Policy</a>
                </label>
                </div>
                <form action="confirm_order.php" method="post">
                    <input type="submit" class="btn btn-primary" name="confirm_credit" value="Place order">
                </form>
            </div>
            </div>
        </div>
